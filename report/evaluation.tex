...
When computing the classification rate, the CBC manual defines it two ways:\\

The average classification rate computed from the cross validation's average error rate
